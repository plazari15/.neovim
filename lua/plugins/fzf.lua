return {
  ...
  keys = {
    ...
    { "<C-p>", "<cmd>FzfLua lsp_live_workspace_symbols<cr>", desc = "Goto Symbol (Workspace)" },
    { "<leader>ht", "<cmd>FzfLua colorschemes<cr>", desc = "Colorscheme with Preview" },
    { "<leader>bf", "<cmd>FzfLua buffers<cr>", desc = "Buffers" },
